...
void safe_check_array_pointers() {
    if (workshy_tests_list == NULL) {
        workshy_tests_list = malloc(sizeof(__workshy_test_function_ptr) *
                                    WORKSHY_DEFAULT_AMOUNT_OF_TESTS);
        memset(workshy_tests_list, 0,
               sizeof(char*) * WORKSHY_DEFAULT_AMOUNT_OF_TESTS);
        assert(workshy_tests_list != NULL && "couldn't allocate memory\n");
    }

    if (workshy_test_function_name_list == NULL) {
        workshy_test_function_name_list =
            malloc(sizeof(char*) * WORKSHY_DEFAULT_AMOUNT_OF_TESTS);
        memset(workshy_test_function_name_list, 0,
               sizeof(char*) * WORKSHY_DEFAULT_AMOUNT_OF_TESTS);
        assert(workshy_test_function_name_list != NULL &&
    ...
    if (workshy_tests_amount + 1 == __workshy_tests_array_capacity) {
        ...
        workshy_tests_list =
            realloc(workshy_tests_list, __workshy_tests_array_capacity);
        workshy_test_function_name_list = realloc(
            workshy_test_function_name_list, __workshy_tests_array_capacity);

        assert(workshy_tests_list != NULL &&
               workshy_test_function_name_list != NULL &&
               "couldn't allocate memory\n");
    }

    if (workshy_benchmark_list == NULL) {
        workshy_benchmark_list =
            malloc(sizeof(__workshy_benchmark_function_ptr) *
                   WORKSHY_DEFAULT_AMOUNT_OF_BENCHMARKS);
        memset(workshy_benchmark_list, 0,
               sizeof(char*) * WORKSHY_DEFAULT_AMOUNT_OF_BENCHMARKS);
    ...
    if (workshy_benchmark_function_name_list == NULL) {
        workshy_benchmark_function_name_list =
            malloc(sizeof(char*) * WORKSHY_DEFAULT_AMOUNT_OF_BENCHMARKS);
        memset(workshy_benchmark_function_name_list, 0,
               sizeof(char*) * WORKSHY_DEFAULT_AMOUNT_OF_BENCHMARKS);
        assert(workshy_benchmark_function_name_list != NULL &&
               "couldn't allocate memory\n");
    }
    ...
    if (workshy_benchmark_amount + 1 == __workshy_benchmark_array_capacity) {
        ...
        workshy_benchmark_list =
            realloc(workshy_benchmark_list, __workshy_benchmark_array_capacity);
        workshy_benchmark_function_name_list =
            realloc(workshy_benchmark_function_name_list,
                    __workshy_benchmark_array_capacity);

        assert(workshy_benchmark_list != NULL &&
               workshy_benchmark_function_name_list != NULL &&
               "couldn't allocate memory\n");
    }
}

void __workshy__register_test(__workshy_test_function_ptr test_function,
                              char* function_name) {
...
void __workshy__register_benchmark(
    __workshy_benchmark_function_ptr test_function, char* function_name) {
    safe_check_array_pointers();
    ...
    workshy_benchmark_function_name_list[workshy_benchmark_amount++] =
        function_name;
}
